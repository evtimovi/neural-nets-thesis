...
network=n.VGGFaceVanillaNoL2(gpu="/gpu:"+str(GPU))
...
def do_mebs_for_subject(subject_id, img_code):
    ...
    with open(OUTPUT_FILE,'a') as f:
        print 'writing output for subject', subject_id, 'to file', OUTPUT_FILE
...
print 'subject_id,img_code,img_filename,l2_vector_begin'
